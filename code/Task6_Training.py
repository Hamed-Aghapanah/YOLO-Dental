...
config = {
    ...
    'dataset_path': 'Task6_LOCALIZER_TO_CLASSIFIER_PIPELINE',
    'output_dir': 'yolov10n_Task6_results'
}
...
def train_yolov10_task6():
    ...
    with open('dataset_config_task6.yaml', 'w') as f:
    ...
    results = model.train(
        data='dataset_config_task6.yaml',
...
if __name__ == "__main__":
    try:
        ...
        print("\n✅ YOLOv10n pipeline for Task6 completed successfully!")
