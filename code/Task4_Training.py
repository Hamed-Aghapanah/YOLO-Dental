...
config = {
    ...
    'dataset_path': 'Task4_frame_classification',
    'output_dir': 'yolov10n_Task4_results'
}
...
def train_yolov10_task4():
    ...
    with open('dataset_config_task4.yaml', 'w') as f:
    ...
    # شروع آموزش
    results = model.train(
        data='dataset_config_task4.yaml',
...
if __name__ == "__main__":
    try:
        ...
        print("\n✅ YOLOv10n pipeline for Task4 completed successfully!")
